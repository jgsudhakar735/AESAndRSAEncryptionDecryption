...
public class RSAGenerateKeys {
	...
	public RSAGenerateKeys(/*int keylength*/) throws NoSuchAlgorithmException, NoSuchProviderException, NoSuchPaddingException {
	...
	public static Map<String, String> getPublicKeyComponents(){
		...
		try {
			// getting keys
			PublicKey publicKey = getPublic("D:/sudhakar/eclipse-jee-luna-R-win32-x86_64/eclipse/workspace/Encryption/KeyPair/publicKey");
